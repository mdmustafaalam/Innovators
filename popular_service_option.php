...
<body>
  ...
  <div class="container-fluid page-header py-5">
    <div class="container text-center py-5">
      <h1 class="display-2 text-white mb-4 animated slideInDown">Selling Crops</h1>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb justify-content-center mb-0 animated slideInDown">
          <li class="breadcrumb-item"><a href="./index.php">Home</a></li>
          <li class="breadcrumb-item"><a href="./service.php">Services</a></li>
          <li class="breadcrumb-item text-white" aria-current="page">Selling Crops</li>
        </ol>
      </nav>
    </div>
  </div>
    ...
    <div class="form-card">
      ...
      <form id="cropForm" class="p-3">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="pricePerKg" name="pricePerKg" placeholder="Enter Price Per Kg"
            required>
        </div>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="description" name="description" rows="3"
            placeholder="Enter Crop Description"></textarea>
        </div>
